...
export class VideosComponent implements OnInit {
    ...
    this.videos = [
      {
        ...
        youtube: 'IbnedIp7jPc', icone: './assets/personagens/zaza.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'Jpz6Um2Dme0', icone: './assets/personagens/julio2.jpg', safeUrl: ''
      },
      ...
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: '7UGa5I0ItJA', icone: './assets/personagens/julio2.jpg', safeUrl: ''
      },
      ...
      {  // tslint:disable-next-line:max-line-length
        ...
        youtube: 'eWA3MnOxvQU', icone: './assets/personagens/lilica.jpg', safeUrl: ''
      },
      ...
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: '5_rRKqIz0Zc', icone: './assets/personagens/zaza.jpg', safeUrl: ''
      },
      ...
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'SM0GZadmTUc', icone: 'assets/icones/tv-cultura.gif', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'raW5KC97SbY', icone: './assets/personagens/julio2.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'KKkZHWFe6LY', icone: './assets/personagens/julio2.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'pXb2X9gDzII', icone: './assets/personagens/julio2.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'r5khCTgV55s', icone: './assets/personagens/julio2.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'V_8OT7wewoA', icone: './assets/personagens/toquinho.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'Y2YJw5_fW6w', icone: './assets/personagens/julio2.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'vFZPysQo0zU', icone: './assets/personagens/lola.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'oMElNCpr2sk', icone: './assets/personagens/oriba.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'dF5XBTawwIo', icone: './assets/personagens/astolfo.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: '9KmqUK7Ru5Y', icone: './assets/personagens/zaza.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'YWhNfscegU8', icone: './assets/personagens/oriba.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'Q8JDIzkc5hQ', icone: './assets/personagens/alipio.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'dMGLS996e70', icone: './assets/personagens/caco.jpg', safeUrl: ''
      },
      { // tslint:disable-next-line:max-line-length
        ...
        youtube: 'F5pNWvTgFlI', icone: './assets/personagens/lilica.jpg', safeUrl: ''
      },
    ];
  ...
  gerarSafeUrls() {
    for (let i = 0; i < this.videos.length; i++) {
      this.videos[i].safeUrl = this.corrigirUrlYoutube(this.videos[i]);
    }
  }
